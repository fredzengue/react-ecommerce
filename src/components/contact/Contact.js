    ...
    <div className="block ">
      ...
      <div className="block mt-16  w-4/5 mx-auto">
        ...
        <p className="text-basetext-gray-500 mt-2  leading-loose text-justify">
          ...
          quod dolorum temporibus, doloremque veritatis deleniti totam dolorem
          unde quam ab sint blanditiis corporis hic mollitia et explicabo magni,
          vitae distinctio. ipsum dolor sit amet consectetur adipisicing elit.
          Voluptate ipsam, nesciunt obcaecati laboriosam iusto quos !
        </p>
      </div>
      ...
      <div
        className="lg:flex flex-row mt-20 w-4/5 h-000 mx-auto 
