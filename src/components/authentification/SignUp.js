...
//   const [errorRepeatPassword, setErrorRepeatPassword] = useState(false);
  ...
  const firstNameChecker = (value) => {
    if (value.length > 0 && (value.length < 3 || value.length >20)) {
      ...
      setErrorFirstName(true)
      errorDisplay('firstname', 'Le name ne doit pas contenir des caractères spéciaux')
      }else{
  ...
  const nameChecker = (value) => {
    if (value.length > 0 && (value.length < 3 || value.length >20)) {
      ...
      setErrorName(true)
      errorDisplay('name', 'Le nom ne doit pas contenir des caractères spéciaux')
      }else{
  ...
  const passwordCheckker = (value) =>{ 
    if (!value.match( /^(?=.*?[A-Z])(?=(.*[a-z]){1,})(?=(.*[\d]){1,})(?=(.*[\W]){1,})(?!.*\s).{8,}$/)) {
        errorDisplay('password', 'Minimum 8 caractères, 1 chiffre, 1 majuscule et un minuscule')
...
// }
  ...
  return (
    ...
    <div className="mt-6 w-4/5 mx-auto " >
      <h1 className="text-2xl font-bold text-black-600 drop-shadow-sm">Sign Up</h1>
      <p className="text-base text-black-600 mt-4">Please fill in this form to create an account.</p>
      ...
      <form ref={form} onSubmit={signUp} >
        <div className="container-firstname">
          <label 
            ...
            >First Name <em className="text-red-500">*</em></label>
          <input
            type="text"
            ...
            className={errorFirstName ? 
              ...
              : ("block rounded-sm border-gray-low border-1 focus:border-1 focus:border-gray focus:ring-0 w-full h-12 rounded-sm")
            } 
          />
          <span></span>
        </div>
        <div className="container-name">
          <label 
            ...
            >Name <em className="text-red-500">*</em></label>
          <input 
            type="text" 
        ...
        <div className="container-email">
          <label 
            htmlFor="email"
            className="block mb-2 mt-4 drop-shadow-lg"
          >Email <em className="text-red-500">*</em></label>
          <input 
            type="text" 
        ...
        <div className="container-password">
          ...
          >Password <em className="text-red-500">*</em>
            ...
            <input
                ...
                name="password"
                onMouseLeave={(e) => 
                    passwordCheckker(e.target.value)
                }
            ...
            />
            <div className="flex ml-40 w-10 translate-x-96 -translate-y-8" onClick={() => setPassswordIsVisible(!passswordIsVisible)} >
                {
                    passswordIsVisible ? <FontAwesomeIcon icon={faEye} style={{color:"#38bdf8"}} /> : <FontAwesomeIcon  icon={faEyeSlash}/>
                }
            </div>
        ...
        <p className="text-base text-black-600 mt-4">By creating an account you agree to our <a className="text-blue-400" href="#">Terms & Privacy</a> </p>
        <div className="flex justify-center mt-2 ">
            <button 
                type="submit"
                className="mt-10 mb-6 mr-2 text-center bg-gray-low text-white  text-base py-4 px-8 hover:bg-gray-low  w-40"
            >Cancel</button>
            <button 
                type="submit"
